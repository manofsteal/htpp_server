...
public:
  ...
  void SetCode(HttpStatusCode code) { code_ = std::optional<HttpStatusCode>(code);}

  HttpMethod method() const { return method_; }
  Uri uri() const { return uri_; }
  std::optional<HttpStatusCode> code() const { return code_; };
...
private:
  HttpMethod method_;
  Uri uri_;
  std::optional<HttpStatusCode> code_;
};
...
public:
  ...
  friend std::string to_string(const HttpResponse& request, bool send_content = true);
